...
The branch delivered more than indexed search. It also completed the PostgreSQL normalization work described by the milestone, moved exact content fetch onto database-backed markdown storage, and split read surfaces so discovery stays body-free. Supporting design references live in [docs/schema.md](../../docs/schema.md) and [docs/storage-strategy-report.md](../../docs/storage-strategy-report.md).
...
- `skill_relationship_selectors` and `skill_dependencies` intentionally coexist. [app/persistence/models/skill_relationship_selector.py](../../app/persistence/models/skill_relationship_selector.py) preserves authored selector text, edge family, order, optionality, and markers exactly as published, while [app/persistence/models/skill_dependency.py](../../app/persistence/models/skill_dependency.py) stores only exact version-to-version edges that can be resolved deterministically during publish or migration backfill.
...
Sources: [alembic/versions/0004_metadata_search_ranking.py](../../alembic/versions/0004_metadata_search_ranking.py), [alembic/versions/0005_normalized_skill_storage_api_cleanup.py](../../alembic/versions/0005_normalized_skill_storage_api_cleanup.py), [app/persistence/models/skill.py](../../app/persistence/models/skill.py), [app/persistence/models/skill_version.py](../../app/persistence/models/skill_version.py), [app/persistence/models/skill_content.py](../../app/persistence/models/skill_content.py), [app/persistence/models/skill_metadata.py](../../app/persistence/models/skill_metadata.py), [app/persistence/models/skill_relationship_selector.py](../../app/persistence/models/skill_relationship_selector.py), [app/persistence/models/skill_dependency.py](../../app/persistence/models/skill_dependency.py), and [app/persistence/models/skill_search_document.py](../../app/persistence/models/skill_search_document.py).
...
- Pure helper behavior is covered by [tests/unit/test_migration_0005.py](../../tests/unit/test_migration_0005.py), [tests/unit/test_search_ranking.py](../../tests/unit/test_search_ranking.py), [tests/unit/test_skill_registry_repository.py](../../tests/unit/test_skill_registry_repository.py), [tests/unit/test_skill_registry_service.py](../../tests/unit/test_skill_registry_service.py), and [tests/unit/test_skill_relationship_service.py](../../tests/unit/test_skill_relationship_service.py).
