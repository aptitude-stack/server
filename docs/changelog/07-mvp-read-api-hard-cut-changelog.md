...
- This milestone chooses deletion over compatibility wrappers. The old public search, relationship batch, identity, version-list, and single-item fetch routes are absent from the router surface and from the documented API contract instead of being kept behind aliases: [tests/unit/test_registry_api_boundary.py](../../tests/unit/test_registry_api_boundary.py), [docs/api-contract.md](../../docs/api-contract.md).
...
- Contract surface and route deletion are enforced by [tests/unit/test_registry_api_boundary.py](../../tests/unit/test_registry_api_boundary.py) and the human-readable contract at [docs/api-contract.md](../../docs/api-contract.md).
